...
The inclusion of various python libraries provides us the framework to work upon. We can thus program several functions and tasks that our bot could perform for the servers that adopt it.
